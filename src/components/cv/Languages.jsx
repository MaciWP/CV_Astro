    ...
    <section id="languages">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {languages.map((lang, index) => (
          <div 
            key={index} 
            className={`bg-light-surface dark:bg-dark-surface rounded-none p-4 border border-light-border dark:border-dark-border transition-all duration-700 transform hover:translate-y-[-8px] hover:shadow-md ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <span className={`px-2 py-0.5 rounded-none text-xs font-semibold ${
                lang.badge === "NATIVE" 
                  ...
                  : "bg-light-secondary dark:bg-dark-surface text-light-text-secondary dark:text-dark-text-secondary border border-light-border dark:border-dark-border"
              }`}>
                {lang.badge}
              </span>
            </div>
