...
export const I18nProvider = ({ children, initialLanguage = null }) => {
    ...
    const [currentLanguage, setCurrentLanguage] = useState(initialLanguage || detectLanguage());
    ...
    const defaultTranslations = {
        en: {
            header: {
                ...
                summary: "Backend Developer specializing in industrial protocols integration"
            },
            sections: {
        ...
        es: {
            header: {
                ...
                summary: "Desarrollador Backend especializado en integración de protocolos industriales"
            },
            sections: {
        ...
        fr: {
            header: {
                ...
                summary: "Développeur Backend spécialisé dans l'intégration de protocoles industriels"
            },
            sections: {
