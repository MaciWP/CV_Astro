...
const StructuredData = ({
  ...
  const personData = {
    ...
    description:
      "Solutions-driven Backend Developer specializing in industrial protocol integration (SNMP, MODBUS, BACnet) with 8+ years of delivering high-performance applications.",
    knowsAbout: skills,
    nationality: {
      "@type": "Country",
      name: "Spain",
