  ...
  const fallbackTranslations = {
    en: {
      ...
      header: {
        ...
        summary:
          "Solutions-driven Backend Developer specializing in industrial protocol integration",
      },
    },
    es: {
      languages: {
      ...
      header: {
        ...
        summary:
          "Desarrollador Backend orientado a soluciones, especializado en integración de protocolos industriales",
      },
    },
    fr: {
      languages: {
      ...
      header: {
        ...
        summary:
          "Développeur Backend axé sur les solutions, spécialisé dans l'intégration de protocoles industriels",
      },
    },
  };
